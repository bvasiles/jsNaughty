...
proxy_nr = xmlrpclib.ServerProxy("http://godeep.cs.ucdavis.edu:8082/RPC2")
...
def parseMosesOutput(moses_output, 
    ...
    for line in moses_output.split('\n'):
        ...
        for line_idx in line_dict.keys():
            ...
            name_candidates[k].setdefault(use_scope, {})
            name_candidates[k][use_scope].setdefault(name_translation, set([]))
...
#     print f_path, f_base, training_strategy, tmp_path, o_path, base_name
    ...
    for k, renaming in renaming_map.iteritems():
        ...
        print '  ', name_candidates[(name, def_scope)][use_scope]
