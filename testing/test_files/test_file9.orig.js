$(document).ready(function() {
    var studentSelector = $("#student-selector"), courseSelector = $("#course-selector");
    ...
    $("table#student-index").tablesorter({
        sortList: [ [ 1, 0 ] ]
    });
    $("table#course-index").tablesorter({
        sortList: [ [ 0, 0 ] ]
    });
    $("table#probation-index").tablesorter({
        sortList: [ [ 1, 0 ] ]
    });
    $("table#course-show").tablesorter({
        sortList: [ [ 1, 0 ] ]
    });
    $("table#student-show").tablesorter({
        sortList: [ [ 0, 0 ] ]
    });
    var studentRows = $("table#student-index > tbody tr"), filterButtons = $("div#grade-filter button");
